        ...
        <section class="e2n-parent-invoice-panel" data-e2n-invoice-panel hidden>
            <article class="e2n-parent-invoice">
                ...
                <div class="e2n-parent-invoice-lines">
                    ...
                    <?php if((float)($invoice['other_amount']??0)>0):?><div><span><?php esc_html_e('Autre','ecole2nat'); ?></span><strong><?php echo esc_html(number_format((float)$invoice['other_amount'],2,',',' ')); ?> €</strong></div><?php endif; ?>
